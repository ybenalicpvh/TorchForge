 ...
 * This file demonstrates how to integrate Torchforge with a web frontend
 */

// For React/Vue/Angular applications
export class TorchforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TorchforgeClient(provider, contractAddress);
